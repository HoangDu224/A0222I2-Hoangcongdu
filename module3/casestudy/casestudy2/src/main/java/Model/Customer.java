...
public class Customer {
    ...
    public Customer(int customer_type_id, String customer_name, String customer_birthday, Boolean customer_gender,
    ...
    public Customer(int customer_id, int customer_type_id, String customer_name, String customer_birthday,
                    Boolean customer_gender, String customer_id_card, String customer_phone, String customer_email,
